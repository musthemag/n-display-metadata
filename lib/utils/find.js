...
exports.author = (annotations) => {
	...
	// If there are multiple authors then we cannot pick just one
	return authors && authors.length === 1 ? authors[0] : undefined;
};

exports.displayTag = (annotations) => {
	return annotations.find((item) => item.predicate === Predicates.DisplayTag);
};
